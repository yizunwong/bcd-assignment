...
import { claims } from '@/src/public/data/admin/claimsData';
import ClaimReviewDialog from '@/src/components/shared/ClaimReviewDialog';
...
type ClaimStatus = "all" | "pending" | "under-review" | "approved" | "rejected";
          ...
          <CardContent className="p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="responsive-stack">
                ...
                <Select
                  value={filterStatus}
                  onValueChange={(value: ClaimStatus) => setFilterStatus(value)}
                >

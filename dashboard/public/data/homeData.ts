...
export const features = [
  {
    ...
    description:
      "Immutable smart contracts ensure transparent and secure transactions with military-grade encryption",
  },
  {
    icon: Zap,
    title: "Instant Payouts",
    description:
      "Automated claim processing with instant ERC-20 token payments - no waiting weeks for approval",
  },
  {
    icon: Globe,
  ...
  },
  {
    ...
    title: "Lower Costs",
    description:
      "Eliminate intermediaries and reduce overhead costs by up to 40% compared to traditional insurance",
  },
  {
    icon: FileText,
    title: "Transparent Claims",
    description:
      "Every claim is recorded on the blockchain for complete transparency and audit trail",
  },
  {
    icon: Clock,
    title: "Real-time Processing",
    description:
      "Smart contracts automatically process claims based on predefined conditions and oracle data",
  },
];
...
export const testimonials = [
  {
    ...
    role: "Digital Nomad",
    content:
      "Coverly made getting travel insurance so simple. The instant payouts saved my trip when my flight was cancelled.",
    rating: 5,
    avatar: "👩‍💻",
  },
  {
    ...
    role: "Farm Owner",
    content:
      "The crop insurance with weather oracles is revolutionary. Automatic payouts based on real weather data - no paperwork hassles.",
    rating: 5,
    avatar: "👨‍🌾",
  },
  {
    ...
    content:
      "As a doctor, I appreciate the transparency of blockchain-based health insurance. Claims are processed fairly and quickly.",
    rating: 5,
    avatar: "👩‍⚕️",
  },
];

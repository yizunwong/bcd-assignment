...
export const users = [
  ...
  },
  {
    ...
    activityLog: [
      ...
      },
      {
        ...
        timestamp: "2024-12-20T15:20:00Z",
        ip: "172.16.0.10",
      },
    ],
  },
  {
    ...
    twoFactorEnabled: false,
    notes:
      "Account suspended due to suspicious claim activity. Under investigation.",
    activityLog: [
      {
...
export const roles = [
  ...
  },
  {
    ...
    description:
      "Insurance company administrators who manage policies and claims",
    permissions: [
